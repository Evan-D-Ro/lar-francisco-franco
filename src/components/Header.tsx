        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 transition-smooth hover:opacity-80">
            ...
            <div className="hidden md:block">
              <h1 className="text-primary font-bold text-lg leading-tight">Lar Francisco Franco</h1>
          ...
          <div className="hidden lg:block">
            <Button variant="cta" size="lg" asChild>
              <Link to="/como-ajudar">Quero Ajudar</Link>
            </Button>
          </div>
          ...
          <nav className="flex flex-col gap-3 py-4">
            {menuItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
                className="text-foreground hover:text-primary transition-smooth text-sm font-medium py-2 border-b border-border"
